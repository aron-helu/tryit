...
const PRODUCTPAGEREVIEWSPage = () => {
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-futuramaxicgdemi items-start justify-start mx-auto w-full">
        <div className="flex items-center w-full">
          <div className="h-[1901px] md:px-5 relative w-full">
            <div className="flex h-full items-center justify-start m-auto w-full">
              <div className="flex flex-col md:gap-10 gap-[1214px] justify-start w-full">
                <Header className="bg-gray_900 flex flex-col items-center justify-center w-full" />
                <div className="flex flex-col font-hind gap-[46px] items-center justify-start md:ml-[0] ml-[262px] w-[74%] md:w-full">
                  <div className="flex items-center justify-start w-[54%] md:w-full">
                    <div className="flex flex-col justify-start w-full">
                      ...
                      <Line className="bg-indigo_900 h-[3px] md:ml-[0] ml-[198px] mr-[315px] mt-0.5 rounded-[1px] w-[19%]" />
                    </div>
                  </div>
                  <div className="flex flex-col gap-9 items-center justify-start w-full">
                    <div className="flex items-center justify-start w-full">
                      <div className="flex flex-col items-start justify-start w-full">
                        <div className="flex md:flex-col flex-row font-hind md:gap-5 items-start justify-start w-full">
                          <Text
                          ...
                          <Img
                            ...
                            className="h-3.5 md:ml-[0] ml-[30px] md:mt-0 mt-1.5 w-auto"
                            alt="rait"
                          />
                          <Img
                            src="images/img_reply.svg"
                            className="h-4 md:ml-[0] ml-[946px] md:mt-0 mt-1 w-4"
                            alt="reply"
                          />
                        </div>
                        <Text
                          className="font-normal font-roboto leading-[24.00px] mt-[13px] not-italic text-gray_700 text-left w-full"
                          variant="body13"
                        >
                          Sed pretium turpis id orci molestie, vitae placerat
                          ligula vulputate. Duis volutpat ante sed laoreet
                          tempus. Vivamus diam purus, vehicula ac tortor ut,
                          dictum vestibulum nisi. Nulla condimentum felis quis
                          augue viverra, et tempor arcu dapibus.
                        </Text>
                        <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start mt-[25px] w-[36%] md:w-full">
                          <Img
                    ...
                    <div className="flex items-center justify-start w-full">
                      <div className="flex flex-col gap-3 items-center justify-start w-full">
                        <div className="flex md:flex-col flex-row font-hind md:gap-5 items-start justify-start w-full">
                          ...
                          <Img
                            src="images/img_rait.svg"
                            className="h-3.5 md:ml-[0] ml-[30px] md:mt-0 mt-[5px] w-auto"
                            alt="rait_One"
                          />
                          <Img
                            src="images/img_reply.svg"
                            className="h-4 md:ml-[0] ml-[956px] md:mt-0 mt-[3px] w-4"
                            alt="reply_One"
                          />
                        </div>
                        <Text
                          className="font-normal font-roboto leading-[24.00px] not-italic text-gray_700 text-left w-full"
                          variant="body13"
                        >
                          Maecenas magna enim, hendrerit sed ex ac, cursus
                          faucibus odio. Vivamus quis placerat orci. Mauris a
                          maximus leo. Proin efficitur orci ex, finibus semper
                          mauris venenatis in. Nunc ac semper lacus. Suspendisse
                          orci purus, pretium sed risus quis, pellentesque
                          interdum turpis. Sed maximus velit at libero rutrum
                          interdum. Curabitur tempor mauris ut sem dictum
                          congue. Etiam imperdiet, magna non vehicula egestas,
                          nunc felis dictum risus, id ornare leo justo id nunc.
            ...
            <ELEMENTSStackrectangleten
              className="absolute font-futuramaxicgbold h-[1620px] inset-x-[0] mx-auto top-[4%] w-[1621px] md:w-full"
              rectangleten="images/img_rectangle10_1.png"
              rectangleeleven="images/img_rectangle11_281x1621.png"
        ...
        <div className="flex font-hind items-end mt-[83px] md:px-10 sm:px-5 px-[517px] w-full">
        ...
        <div className="flex flex-col font-montserrat md:gap-10 gap-[63px] items-center mt-14 w-full">
          ...
          <div className="font-futuramaxicgbook h-[1170px] md:h-[534px] md:px-5 relative w-full">
            <PRODUCTPAGEDESCRIPTIONColumnbackground
              ...
              background="images/img_background_219x1620.png"
