...
const CardssectionexampleSixPage = () => {
  return (
    <>
      <div className="flex flex-col font-montserrat mx-auto relative w-full">
        <div className="bg-gray_900 flex items-center justify-start max-w-[1512px] mx-auto py-[100px] w-full">
...
export default CardssectionexampleSixPage;
