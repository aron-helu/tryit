...
const CardssectionexampleSevenOnePage = () => {
  return (
    <>
      <div className="flex flex-col font-montserrat mx-auto pb-[13px] relative w-full">
        <div className="bg-white_A700 flex items-center justify-start max-w-[1620px] mx-auto py-[100px] w-full">
          <div className="flex items-center justify-start max-w-[1175px] mx-auto pb-10 md:px-5 w-full">
        ...
        <div className="gap-6 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-center max-w-[1175px] mt-[-160px] mx-auto md:px-5 py-2.5 w-full z-[1]">
...
export default CardssectionexampleSevenOnePage;
