...
const HOMEPAGEColumnThirteen = (props) => {
  return (
    <>
          ...
          <div className="flex md:flex-1 flex-col gap-[30px] items-center justify-start w-[48%] md:w-full">
            <div className="h-[530px] relative w-full">
              ...
              <div className="absolute flex flex-col gap-[37px] inset-x-[0] items-center justify-start mx-auto top-[8%] w-auto">
                <Text
                  className="font-futuramaxicgbold font-normal leading-[40.00px] text-center text-gray_800 w-full"
                  variant="body5"
                >
            ...
            <div className="h-[460px] relative w-full">
              ...
              <div className="absolute flex flex-col gap-6 inset-x-[0] items-center justify-start mx-auto top-[11%] w-auto">
                <Text
                  className="font-futuramaxicgbold font-normal text-center text-yellow_A701 w-auto"
                  variant="body5"
                >
                  {props?.mediumlengthdisOne}
                </Text>
                <Text
                  className="font-futuramaxicgbook font-normal leading-[22.00px] text-center text-yellow_A701 w-full"
                  variant="body15"
                >
          ...
          <div className="flex md:flex-1 flex-col gap-[30px] items-center justify-start w-[48%] md:w-full">
            <div className="h-[460px] relative w-full">
              ...
              <div className="absolute flex flex-col gap-2 inset-x-[0] items-center justify-start mx-auto top-[10%] w-auto">
                <Text
                  className="font-futuramaxicgbold font-normal leading-[40.00px] text-center text-white_A700 w-full"
                  variant="body5"
                >
            ...
            >
              <Text
                className="font-futuramaxicgbold font-normal leading-[40.00px] mr-5 mt-5 text-center text-gray_800 w-[89%] sm:w-full"
                variant="body5"
              >
...
HOMEPAGEColumnThirteen.defaultProps = {
...
export default HOMEPAGEColumnThirteen;
