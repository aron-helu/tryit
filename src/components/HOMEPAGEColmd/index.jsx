        ...
        >
          <div className="flex items-end justify-end p-[15px] w-full">
            <div className="flex flex-col items-end justify-start mr-0.5 mt-[50px] w-[53%] md:w-full">
              <Text
                className="font-futuramaxicgbook font-normal text-gray_703 text-right w-auto"
                variant="body15"
              >
                {props?.h6}
              </Text>
              ...
              <div className="flex flex-row gap-[15px] items-center justify-end ml-auto mt-[35px] w-[63%] md:w-full">
                <Text
                  className="font-futuramaxicgbook font-normal text-bluegray_901 text-right w-auto"
                  variant="body15"
                >
                  {props?.h6One}
                </Text>
                <Button className="border border-solid border-yellow_A700 flex h-[49px] items-center justify-center px-5 py-[17px] rotate-[180deg] rounded-[24px] w-12">
                  <Img
